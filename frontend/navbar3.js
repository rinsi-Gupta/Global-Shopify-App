    ...
    <div class="flex flex-col md:flex-row items-center justify-between px-4 md:px-6 py-4 gap-y-4" id="category-section">
        ...
        <div class="w-full md:flex-1 overflow-x-auto custom-scroll" id="scroll-container">
            <div class="min-w-max flex justify-start md:justify-center items-center gap-6 md:gap-8 font-semibold whitespace-nowrap" id="category-links">
                <a href="her.html" data-category="Jewellery" class="category-link">Gifts For Her</a>
                <a href="him.html" data-category="portrait" class="category-link">Gifts For Him</a>
                <a href="festive.html" data-category="bags" class="category-link">Festive Gifts</a>
                <a href="birthday.html" data-category="wed" class="category-link">Birthday Gifts</a>
                <a href="wedding.html" data-category="birth" class="category-link">Wedding Gifts</a>
                <a href="personal.html" data-category="plant" class="category-link">Personalized Gifts</a>
            </div>
        </div>
    </div>
</nav>
