...
<nav class="bg-white/90 backdrop-blur-sm w-full shadow-md sticky top-0 z-40">
    ...
    <div class="w-full bg-white">
        <div class="flex overflow-x-auto whitespace-nowrap scrollbar-hide md:justify-center gap-6 py-3 px-4 text-sm font-semibold" id="categoryBar">
            <div class="group relative inline-block">
                <a href="lightings.html" class="category-link hover:text-blue-500">LIGHTINGS</a>
            </div>
            <div class="group relative inline-block">
                <a href="accessory.html" class="category-link hover:text-blue-500">ACCESSORIES</a>
            </div>
            <div class="group relative inline-block">
                <a href="utility.html" class="category-link hover:text-blue-500">UTILITY</a>
            </div>
            <div class="group relative inline-block">
                <a href="wooden.html" class="category-link hover:text-blue-500">WOODEN</a>
            </div>
            <div class="group relative inline-block">
                <a href="pottery.html" class="category-link hover:text-blue-500">POTTERY</a>
            </div>
            <a href="wall.html" class="category-link inline-block hover:text-blue-500">WALL DECOR</a>
            <div class="group relative inline-block">
                <a href="textile.html" class="category-link hover:text-blue-500">TEXTILE</a>
            </div>
        </div>
    </div>
</nav>
